...
## モデルの学習結果
以下各モデルの評価結果です。
| モデル |   MAE   |  MSE  |  RMSE  |  RMSLE  |   R2   |
| :----: |:-----: |:-----: |:-----: |:-----: |:-----: |
| 360-90 | 0.0257 | 0.0022 | 0.0471 | 0.0353 | 0.9052 |
| 90-90  | 0.0215 | 0.0018 | 0.0418 | 0.0313 | 0.9247 |
...
## TODO
- 実験のセッティングをファイルに記載して保存
- トレーニング済みモデルを読み込んで複数のテスト結果をプロットしたものを出力
- キャッシュを作成するか選択できるようにする
- data/store-sales/train.csv 以外のファイルも使用して特徴量エンジニアリングを行う